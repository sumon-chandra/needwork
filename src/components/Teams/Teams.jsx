  ...
  return (
    <div className="page-head">
      ...
      <h2 className="text-center service-title">Our Expert Team Member</h2>
        <div className="row row-cols-1 row-cols-lg-4 row-cols-md-2 g-4 mb-5">
            ...
            <div className="card card-details d-flex flex-column justify-content-center align-items-center">
              ...
              <div className="card-body">
                ...
                <div className="social-links social mt-3">
                  <a
                    target="_blank"
                    href="https://www.facebook.com/rakib44550"
                  >
                    <i className="fab fa-facebook-f"></i>
                  </a>
                  ...
                  <a
                    target="_blank"
                    href="https://www.linkedin.com/in/md-rakib-hossain-1366b1178/"
                  >
                    <i className="fab fa-linkedin-in"></i>
                  </a>
                </div>
            ...
            <div className="card card-details d-flex flex-column justify-content-center align-items-center">
              ...
              <div className="card-body">
                ...
                <div className="social-links social mt-3">
                  <a
                    target="_blank"
                    href="https://www.facebook.com/sohanali420"
                  >
                    <i className="fab fa-facebook-f"></i>
                  </a>
                  ...
                  <a
                    target="_blank"
                    href="https://www.linkedin.com/in/advance-seo-experts-bangladesh/"
                  >
                    <i className="fab fa-linkedin-in"></i>
                  </a>
                </div>
            ...
            <div className="card card-details d-flex flex-column justify-content-center align-items-center">
              ...
              <div className="card-body">
                ...
                <div className="social-links social mt-3">
                  <a
                    target="_blank"
                    href="https://www.facebook.com/md.sabbi.92"
                  >
                    <i className="fab fa-facebook-f"></i>
                  </a>
                  <a  href="#">
